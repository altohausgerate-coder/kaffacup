          ...
          <motion.div className="bg-primary rounded-2xl p-8 text-white flex flex-col justify-center gap-5 shadow-lg"
            ...
            <div>
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Azərbaycan prospekti 13/16<br />Sumqayıt
              </p>
            </div>
            <div>
              <h4 className="font-heading font-semibold text-lg mb-2">📞 {t('contact.phone')}</h4>
            ...
            <div>
              <h4 className="font-heading font-semibold text-lg mb-2">🕐 {t('contact.hours')}</h4>
              <p className="text-white/80 text-sm">{t('contact.hours.value')}</p>
            </div>
            <div>
