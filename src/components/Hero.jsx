  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 top-1/2 z-10 mx-auto flex w-full max-w-5xl -translate-y-1/2 flex-col items-center text-center px-4">
        ...
        <h1
          className="font-display text-white mb-5 inline-block scale-x-[0.78] whitespace-nowrap leading-none text-[4rem] min-[380px]:text-[4.4rem] sm:scale-x-100 sm:text-[6.25rem] md:text-[7.5rem] lg:text-[9rem]"
          style={{
            letterSpacing: 0,
