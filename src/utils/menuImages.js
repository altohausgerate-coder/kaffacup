...
const LOCAL_IMAGE_OVERRIDES = {
  ...
  s2: '/images/food/toyuq-salati.png',
  s3: '/images/food/sezar-salati.png',
  s4: '/images/food/ton-baligi-salati.png',
  s5: '/images/food/meat-salad.png',
  sw1: '/images/food/toyuq-sezar-sendvic.png',
  sw2: '/images/food/ton-baligi-sendvic.png',
  sw3: '/images/food/klab-sendvic.png',
  sw4: '/images/food/toyuq-bagette.png',
